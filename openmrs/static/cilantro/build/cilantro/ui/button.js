...
define(['./core', 'tpl!templates/button/select.html', 'tpl!templates/button/select-option.html'], function() {
  var ButtonSelect, ButtonSelectEmptyOption, ButtonSelectOption, c, templates, _ref, _ref1;
  ...
  ButtonSelectEmptyOption = (function(_super) {
    ...
    ButtonSelectEmptyOption.prototype.template = templates.option;
  ...
  ButtonSelectOption = (function(_super) {
    ...
    ButtonSelectOption.prototype.template = templates.option;
  ...
  ButtonSelect = (function(_super) {
    ...
    ButtonSelect.prototype.template = templates.select;
    ...
    function ButtonSelect(options) {
      ...
      if (!(options.collection instanceof c.Backbone.Collection)) {
