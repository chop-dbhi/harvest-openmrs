...
define(['../core', './dist', './axis', 'tpl!templates/charts/editable-chart.html'], function() {
  var EditableFieldChart, axis, c, dist, templates, _ref;
  c = arguments[0], dist = arguments[1], axis = arguments[2], templates = 4 <= arguments.length ? __slice.call(arguments, 3) : [];
  ...
  EditableFieldChart = (function(_super) {
    ...
    EditableFieldChart.prototype.template = templates.editable;

    EditableFieldChart.prototype.events = c._.extend({
      'click .fullsize': 'toggleExpanded'
    }, dist.FieldChart.prototype.events);

    EditableFieldChart.prototype.ui = c._.extend({
      toolbar: '.btn-toolbar',
