...
define(['./core', './base', 'tpl!templates/paginator.html'], function() {
  var EmptyPage, ListingPage, LoadingPage, Page, PageRoll, Paginator, base, c, templates, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
  ...
  Paginator = (function(_super) {
    ...
    Paginator.prototype.template = templates.links;
    ...
    Paginator.prototype.initialize = function() {
      return this._changePage = c._.debounce(this.changePage, this.requestDelay);
    };
    ...
    Paginator.prototype.renderCurrentPage = function(model, value, options) {
      ...
      return this.ui.last.prop('disabled', !!options.last);
    };
  ...
  PageRoll = (function(_super) {
    ...
    PageRoll.prototype.itemViewOptions = function(item, index) {
      ...
      if (this.options.list) {
        c._.extend(options, this.listViewOptions(item, index));
      }
      return c._.defaults(options, this.options);
    };
