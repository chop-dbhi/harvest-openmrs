...
import base_test
class VerifyPatientMRN000002(base_test.BaseTest):
    def setUpNA(self):
    ...
    def test_verify_patient_m_r_n000002(self):
        driver = self.driver
        ...
        try:
            driver.find_element_by_link_text("MRN000002").click()
            assert 1
        except:
            driver.get_screenshot_as_file("{0}/{1}/{2}/{3}/{4}".format(os.getcwd(),"headless_tests","test","screen_shots","VerifyPatientMRN000002.png"))
            assert 0, "Link MRN000002 not found"
