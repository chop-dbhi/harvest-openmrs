...
import base_test
import os
class VerifyPatientMRN000013(base_test.BaseTest):
    def setUpNA(self):
    ...
    def test_verify_patient_m_r_n000013(self):
        driver = self.driver
        ...
        try:
            driver.find_element_by_link_text("MRN000013").click()
            assert 1
        except:
            driver.get_screenshot_as_file("{0}/{1}/{2}/{3}/{4}".format(os.getcwd(),"headless_tests","test","screen_shots","VerifyPatientMRN000013.png"))
            assert 0, "Link MRN000013 not found"
