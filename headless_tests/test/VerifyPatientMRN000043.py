...
import base_test
import os
class VerifyPatientMRN000043(base_test.BaseTest):
    def setUpNA(self):
    ...
    def test_verify_patient_m_r_n000043(self):
        driver = self.driver
        ...
        try:
            driver.find_element_by_link_text("MRN000043").click()
            assert 1
        except:
            driver.get_screenshot_as_file("{0}/{1}/{2}/{3}/{4}".format(os.getcwd(),"headless_tests","test","screen_shots","VerifyPatientMRN000043.png"))
            assert 0, "Link MRN000043 not found"
